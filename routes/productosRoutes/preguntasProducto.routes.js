...
import { crearPregunta,
    crearRespuesta,
    getPreguntasByIdProducto,
    eliminarPregunta,
    actualizarPregunta, } from "../../controllers/productosControllers/preguntasProducto.controller.js";
...
router.get("/producto-preguntas/producto/:id_producto", getPreguntasByIdProducto);
